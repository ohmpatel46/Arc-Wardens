    ...
    <div className="w-64 bg-gray-50 border-r border-gray-200 flex flex-col">
      ...
      <div className="border-t border-gray-200 p-4 bg-white space-y-2">
        <button
          ...
          className={`w-full flex items-center gap-2 p-3 rounded-md transition ${showAnalytics
        ...
        <button
          ...
          className={`w-full flex items-center gap-2 p-3 rounded-md transition ${showWallet
            ? 'bg-blue-700 text-white'
            : 'hover:bg-gray-100 border border-transparent text-gray-700'
            }`}
        >
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-2 p-3 rounded-md transition hover:bg-red-50 border border-transparent text-red-600 group"
        >
